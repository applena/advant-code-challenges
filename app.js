...
function frequency (nums){
  ...
  for(let i = 0; i < strArr.length; i++) {
    ...
    //adds more terms to the array
    strArr.push(strArr[i]);

    //adds the next term to the total
    total = parseInt(strArr[i]) + total;

    //puts the total into the freq array
    freq.push(total);

    //cycles through the freq array to look for a match
